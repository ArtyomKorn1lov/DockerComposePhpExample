...
INSERT INTO `catalog` (`ID`, `NAME`, `PRICE`, `TEXT`, `PICTURE`, `PRODUCT_DAY`)
VALUES (1, 'HTC HERO', 1000,
        'Третий коммуникатор на платформе Android, выпущенный компанией HTC. Это первый телефон серии, оснащённый аудиовыходом 3,5 мм, мультитач-экраном и новым интерфейсом HTC Sense. Телефон был представлен 24 июня 2009 года в Лондоне.',
        '/template/images/goods/htc.jpg', 0),
       (2, 'Iphone 7 ', 4000,
        ...
        '/template/images/goods/iphone.jpg', 0),
       (5, 'Samsung Galaxy Note 4', 2500,
